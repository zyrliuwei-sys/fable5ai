export const meta = {
  ...
  description: 'The terms and conditions for using Fable5AI.',
  updated_at: '2026-06-11',
};

## Acceptance of Terms

By accessing or using Fable5AI (the "Service"), available at fable5ai.it.com, you agree to be bound by these Terms of Service. If you do not agree, please do not use the Service.
...
The Service and its original content, features, and functionality are owned by Fable5AI and are protected by international copyright, trademark, and other intellectual property laws.
...
If you have questions about these Terms, please contact us at the email address provided on our website at [fable5ai.it.com](https://fable5ai.it.com).
