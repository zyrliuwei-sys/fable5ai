...
/**
 * Fable5AI marketing landing — All-in-One AI Agent.
 *
 * The site root `/` now redirects to the /agent console (mirroring
 * chatlyai.app → /agent). The full marketing landing is preserved here at
 * `/home` so its SEO copy, structured data, and content remain intact and
 * reachable. If you want the landing back at `/`, swap this file's route path
 * with the redirect in src/routes/index.tsx.
 *
...
export const Route = createFileRoute('/home')({
  ...
  head: ({ loaderData }) => {
    ...
    const appUrl =
      ...
      envConfigs.app_url ||
      '';
    const canonicalUrl = localizeUrl(`${appUrl}/home`, { locale: loc }).href;
    ...
    const urlFor = (l: string) =>
      localizeUrl(`${appUrl}/home`, { locale: l as any }).href;
